<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('运单信息表')">导出</a-button>
    ...
    <waybill-info-modal ref="modalForm" @ok="modalFormOk"/>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/waybillInfo/waybillInfo/list",
          delete: "/waybillInfo/waybillInfo/delete",
          deleteBatch: "/waybillInfo/waybillInfo/deleteBatch",
          exportXlsUrl: "/waybillInfo/waybillInfo/exportXls",
          importExcelUrl: "waybillInfo/waybillInfo/importExcel",
